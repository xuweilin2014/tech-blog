...
<div align="center">
    ...
    <img src="程序的机器级表示_static/47.png" width="450"/>
</div>
...
<div align="center">
    ...
    <img src="程序的机器级表示_static/48.png" width="400"/>
</div>
...
<div align="center">
	<img src="程序的机器级表示_static/49.png" width="330"/>
</div>
...
<div align="center">
	...
	<img src="程序的机器级表示_static/50.png" width="350"/>
</div>
...
<div align="center">
	...
	<img src="程序的机器级表示_static/51.png" width="450"/>
</div>
...
<div align="center">
	...
	<img src="程序的机器级表示_static/52.png" width="300"/>
</div>
...
<div align="center">
	...
	<img src="程序的机器级表示_static/53.png" width="300"/>
</div>
...
执行这一步骤的命令需要具有 root 权限，因为该文件的拥有者是 root 用户。再次运行程序，这次显示了不同的结果，程序还打印出了有效用户 ID(euid)，它的值是 0，因此该进程拥有 root 权限。
